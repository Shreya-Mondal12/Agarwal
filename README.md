# Closure Disclosure Benefit Summary Dashboard
...
* Calculate CD returns over time
...
│── cd_benefit_summary.py  # CD calculation logic
...
```bash
git clone https://github.com/Shreya-Mondal12/Agarwal.git
cd Agarwal
```
